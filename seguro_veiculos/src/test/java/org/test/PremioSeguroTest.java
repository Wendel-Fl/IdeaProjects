...
public class PremioSeguroTest {
    ...
    public void testFemininoSNI() {
        ...
        cliente.setDataNascimento(DataUtils.StringToDate("03/08/1997"));
    ...
    public void testFemininoCNI() {
        ...
        cliente.setDataNascimento(DataUtils.StringToDate("25/05/1997"));
        cliente.setNacionalidade("Brasileira");
    ...
    public void testMasculinoSNS() {
        cliente.setSexo("Masculino");
        cliente.setEstadoCivil("Solteiro");
        cliente.setDataNascimento(DataUtils.StringToDate("17/03/1997"));
        cliente.setNacionalidade("Brasileira");
    ...
    public void testMasculinoCNS() {
        cliente.setSexo("Masculino");
        cliente.setEstadoCivil("Casado");
        cliente.setDataNascimento(DataUtils.StringToDate("17/07/1997"));
        cliente.setNacionalidade("Brasileira");
